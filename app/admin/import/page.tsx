...
export const metadata = {
  title: "Admin Import",
  description: "Manual listing import and publishing flow for Sweepza admins.",
};
    ...
    return (
      <section className="px-5 pb-10 pt-8">
        <div className="rounded-card border border-sand bg-white/80 p-5">
          <h1 className="text-2xl font-bold text-ink">Admin import unavailable</h1>
    ...
    return (
      <section className="px-5 pb-10 pt-8">
        <div className="rounded-card border border-sand bg-white/80 p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-ink/65">
            Admin import is only available to authenticated Sweepza admins or owners.
          </p>
    ...
    return (
      <section className="px-5 pb-10 pt-8">
        <div className="rounded-card border border-sand bg-white/80 p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-ink/65">
            This import flow is limited to Sweepza admin and owner accounts.
          </p>
        </div>
      </section>
    );
    ...
    <section className="px-5 pb-10 pt-8">
      <div className="flex flex-col gap-4">
        <header>
          ...
          <h1 className="mt-1 text-2xl font-bold text-ink">Manual listing import</h1>
          <p className="mt-2 text-sm leading-relaxed text-ink/65">
            Create a canonical listing directly in Sweepza, attach controlled tags,
            and publish it without leaving the app.
          </p>
        </header>

        <AdminListingImportForm categories={categories} tags={tags} />
      </div>
    </section>
  );
}
